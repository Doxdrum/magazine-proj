...
\lead[En los \'ultimos a\~nos la nanotecnolog\'ia se ha convertido en un pilar fundamental del desarrollo, descubramos algunas de sus aplicaciones.]
...
\illustration{concrete1.jpg}{Nano-concreto}{Requiere poco material para obtener la misma resistencia y su producci\'on genera un m\'inimo  de emisiones}
%\item 
...
%\end{Auflistung}
%\illustration{concrete0.jpg}{Concreto tradicional}{Requiere gran cantidad de material y su producci\'on genera gran cantidad de emisiones}
...
%\end{Auflistung}
\illustration{nanopista1.jpg}{Nano-inyecci\'on}{Ilustraci\'on de un medicamento conducido a trav\'es de un nanotubo}
